...
import '../DTO/PaymentRecord.dart';
import 'package:autonetwork/DTO/UserProfileDTO.dart';
import '../utils/string_helper.dart';
import '../Pages/Components/helpers/SaleInvoicePdfHelper.dart';
...
class _InventorySaleLogDetailCardState extends State<InventorySaleLogDetailCard> {
  ...
  void _loadUserProfile() async{
    ...
    storeName = await UserPrefs.getStoreName();
  }
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Column(
        children: [
          ListTile(
            title: Text('Satış Tarihi: ${currentLog.saleDate != null ? "${currentLog.saleDate!.year.toString().padLeft(4,'0')}-${currentLog.saleDate!.month.toString().padLeft(2,'0')}-${currentLog.saleDate!.day.toString().padLeft(2,'0')}" : '-'}'),
